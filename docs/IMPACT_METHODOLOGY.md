...
Local parcel contributions become zero beyond five miles. The model uses different characteristic distances because effects do not travel in the same way:
