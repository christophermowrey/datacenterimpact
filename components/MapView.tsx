...
export type SearchedLocation = { latitude: number; longitude: number; label: string; coverage?: 'supported' | 'outside' | 'unknown'; source?: 'google' | 'openstreetmap' | 'arcgis'; precision?: 'exact_address' | 'place_label' | 'municipality_boundary' | 'zip_centroid'; fallbackReason?: 'exact_address_not_found' }
