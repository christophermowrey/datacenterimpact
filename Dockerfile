...
ARG NEXT_PUBLIC_USE_OSM_FALLBACK
ARG NEXT_PUBLIC_OSM_TILE_URL
ARG NEXT_PUBLIC_SHOW_CANDIDATES
ENV NEXT_PUBLIC_MAP_STYLE_URL=$NEXT_PUBLIC_MAP_STYLE_URL
ENV NEXT_PUBLIC_USE_OSM_FALLBACK=$NEXT_PUBLIC_USE_OSM_FALLBACK
ENV NEXT_PUBLIC_OSM_TILE_URL=$NEXT_PUBLIC_OSM_TILE_URL
ENV NEXT_PUBLIC_SHOW_CANDIDATES=$NEXT_PUBLIC_SHOW_CANDIDATES
